...
import { studentsRef } from './../firebase/db';
                        ...
                        <div>
                            ...
                            <Grid columns={1} centered>
                                <Grid.Column mobile={16} tablet={12} computer={10}>
                                    <h1 style={{ marginTop: 50, marginBottom: 20 }}>Modifiez vos listes</h1>
...
export default withAuthorization(authCondition)(EditStudents);