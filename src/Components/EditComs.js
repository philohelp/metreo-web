...
import { commentsRef } from './../firebase/db';

import { Grid, Message, Button, Icon } from 'semantic-ui-react';

class EditComs extends React.Component {
    constructor(props) {
        super(props);
        this.myref = commentsRef();
        this.state = {
            data: [],
            errorMessage: null,
            hiddenNeg: true,
                        ...
                        <div>
                            ...
                            <Grid columns={1} centered>
                                <Grid.Column mobile={16} tablet={12} computer={10}>
                                    <h1 style={{ marginTop: 50, marginBottom: 20 }}>Personnalisez vos remarques</h1>
...
export default withAuthorization(authCondition)(EditComs);